...
//   const { bitcoin, ethereum , ada } = useSelector((state: RootState) => state.prices);
...
//   useEffect(() => {
//     const ws = new WebSocket("wss://ws.coincap.io/prices?assets=bitcoin,ethereum,ada");
//     ws.onmessage = (event) => {
...
//         <LivePrices prices={{ bitcoin, ethereum , ada }} />
//         <TradeForm
//           prices={{ bitcoin, ethereum , ada }}
//           onTrade={handleTrade}
//           cryptoBalance={cryptoBalance}
//           cashBalance={cashBalance}
//         />
//         <OrderList orders={orders} livePrices={{ bitcoin, ethereum , ada }} />
//       </div>
//     </>
//   );
// }
